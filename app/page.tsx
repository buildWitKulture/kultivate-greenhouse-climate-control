      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <div>
          ...
          <p className="text-pretty text-muted-foreground">
            Monitor and control your greenhouse climate systems
          </p>
        </div>
            ...
            >
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Badge
                    variant={
                      greenhouse.mode === "normal" ? "default" : "secondary"
                    }
                  >
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="font-semibold">
                        {greenhouse.sensors?.gasLevel} ppm
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                  >
                    <Link href={`/greenhouse/${greenhouse.id}/simulate`}>
                      Simulate
                    </Link>
                  </Button>
                </div>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              <p className="text-muted-foreground">
                No greenhouses found. Initialize the database to get started.
              </p>
