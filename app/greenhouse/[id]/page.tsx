      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-2">
            <Badge
              variant={greenhouse.mode === "normal" ? "default" : "secondary"}
              className="h-fit"
            >
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                Target:{" "}
                {greenhouse.normalMode?.parameters?.targetSoilMoistureMin}-
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Current state of all control systems
            </CardDescription>
          </CardHeader>
          <CardContent>
...
function ActuatorStatus({
  ...
  return (
    <div className="flex items-center gap-3 rounded-lg border border-border p-3">
      <div
        className={`rounded-full p-2 ${active ? "bg-primary/10" : "bg-muted"}`}
      >
        <Icon
          className={`h-4 w-4 ${
